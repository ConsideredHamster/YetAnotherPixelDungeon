...
import com.consideredhamster.yetanotherpixeldungeon.effects.particles.FlowParticle;
import com.consideredhamster.yetanotherpixeldungeon.effects.particles.LeafParticle;
import com.consideredhamster.yetanotherpixeldungeon.effects.particles.WindParticle;
...
import com.consideredhamster.yetanotherpixeldungeon.mechanics.ShadowCaster;
...
//                case Terrain.HIGH_GRASS:
//                    if (Dungeon.visible[cell]) {
//                        CellEmitter.get(cell).burst(LeafParticle.LEVEL_SPECIFIC, Random.IntRange(2, 3));
//                    }
//                    break;
//
//                case Terrain.GRASS:
//                    if (Dungeon.visible[cell]) {
//                        CellEmitter.get(cell).burst(LeafParticle.LEVEL_SPECIFIC, Random.IntRange(1, 2));
//                    }
//                    break;
//
//                case Terrain.DOOR_CLOSED:
