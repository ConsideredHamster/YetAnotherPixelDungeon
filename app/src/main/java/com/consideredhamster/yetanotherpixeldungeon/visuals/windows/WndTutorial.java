...
public class WndTutorial extends WndTabbed {
    ...
    private static final String[][] TXT_POINTS = {
        ...
        },
        {
            ...
            "In the darkness of the dungeon, ambient lighting is barely noticeable, limiting your field of vision. To counter this, you can use lantern you start with. It basically nullifies your Stealth though, so use it wisely.",
