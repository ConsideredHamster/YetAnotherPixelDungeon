...
public class WndTutorial extends WndTabbed {
    ...
    private static final String[][] TXT_POINTS = {
        ...
        },
        {
            ...
            "As you descend deeper into the dungeon, ambient lighting becomes less and less noticeable, limiting your field of vision. To counter this, you can use torches scattered around the dungeon. They nullify your Stealth though, so use them wisely.",
            ...
            "Sometimes in the high grass you can find alchemical herbs. Throw three of them into an alchemy pot to brew a potion. Type of the potion will depend on the herbs you used (order in which herbs are thrown into the pot is not important). Using three herbs of the same type will always produce corresponding potion.",
