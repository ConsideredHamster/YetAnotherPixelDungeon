...
import com.consideredhamster.yetanotherpixeldungeon.windows.WndHero;
import com.consideredhamster.yetanotherpixeldungeon.windows.WndInfoCell;
import com.consideredhamster.yetanotherpixeldungeon.windows.WndInfoItem;
import com.consideredhamster.yetanotherpixeldungeon.windows.WndInfoMob;
...
//		} );
        ...
        add( btnQuick1 = new QuickslotTool( 82, 0, 22, 24, true ) );
        add( btnQuick2 = new QuickslotTool( 82, 0, 22, 24, false ) );
...
//		btnInfo.setPos( btnSearch.right(), y );
        ...
        btnQuick0.setPos( width - btnQuick1.width(), y - btnQuick1.height() );
        btnQuick2.setPos( btnInventory.left() - btnQuick2.width(), y );
