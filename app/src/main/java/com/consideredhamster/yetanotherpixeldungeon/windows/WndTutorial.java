    ...
    private static final String[][] TXT_POINTS = {
        {
            ...
            "Depending on your settings, this button can be tapped or pressed to make your character search nearby tiles, revealing traps and secret doors. Alternatively, it allows you to examine anything you meet in the dungeon.",
            ...
            "To the left of the inventory button you can see two quickslots. You can use some items from there without need to open your inventory. You can set items for the quickslots by pressing and holding them.",
			...
			"Resume button is only shown then your current action was interrupted by an attack, receiving damage or something else. Obviously, it allows you to resume the interrupted action after observing the situation, if you want to."
        },
		{
			"Most actions in the game spend one turn when performed, which means that one attack spend just as much time as one tile travelled, and that almost everyone moves with the same speed. Be careful, as actions take their effect the moment they are performed and make the character wait after that.",
            "Enemies have a certain chance to notice you. It depends on their detection value and your stealth value. It also depends on the distance between you and the mob, but the mobs who are already on the hunt will have 100% chance to notice you if they can see you at all. They are less likely to notice you while they are sleeping though.",
            "However, as enemy loses sight of you, they can lose track of you and become open to sneak attack. The chance of this to happen mostly depends on your stealth, you can also utilize corners, doors or high grass for this tactic. However, mind that flying creatures can see over high grass.",
            ...
            "Dexterity value of the defender is decreased by 6.25% for every occupied or impassable tile near it. This means that you should lure your enemies to narrow corridors if you want to miss less often, and you'll want to stick to the open areas if you want to dodge more reliably.",
            "All ranged attacks get their accuracy decreased by 12.5% for every tile of distance. The only exception for this rule are flintlock weapons and certain kinds of wands. Also, wands use your wand skill to determine your chance to hit with them (as of now, only combat wands can miss).",
            "For the player character (and some late-game mobs), every consecutive hit after the second one slightly increases damage done by the attack. This is shown by the \"combo\" message over your character and can significantly increase your effectiveness against packs of mobs.",
            "Your detection attribute affects your chances to find a trap or a secret door by walking near it, as well as your chance to hear an enemy through the wall. Mind that secrets become more difficult to find as you descend further into the dungeon.",
			"High grass is extremely useful for setting up ambushes, as it both blocks field of view and increases your stealth. However, water is noisy and will decrease your stealth when you are standing in it.",
            ...
            "Your chance to notice a hidden door or trap, your chance to hear an enemy through a wall and your chance to detect a curse on the item before you'll equip it all depend on your Detection attribute.",
            "Your magic power very significantly affects wands recharge rate, and also determines effectiveness of certain offensive scrolls. Wand skill determines your accuracy with wands.",
        },
        {
            ...
            "Throwing weapons can be equipped in your offhand slot. They can't be upgraded, but they allow you to attack from distance while keeping your melee weapon equipped. Also, they will never be cursed or damaged, and they can be used as is.",
            "Ranged weapons require both hands to use - one to hold the weapon and second to hold its ammunition. Without ammunition, you will attack as if you had no weapon at all. ",
            "Flintlock weapons require bullets in your offhand to shoot and gunpowder in your inventory to reload. Also, they draw attention. However, firearms are equally accurate on any distance and they penetrate target's armor.",
			...
			"Cloth armors offer very little protection but they can increase one of your attributes - stealth, detection or magic power. This bonus can be increased by upgrading the armor, and can lead to some powerful (but risky) character builds.",
            "Shields occupy your offhand slot, but they increase your armor class even further and are very effective at blocking enemy blows. When blocking or parrying enemy blows, you have a chance to leave your enemy open to a counter attack, which will be a guaranteed hit and will deal bonus damage.",
            "Wands can be very powerful, but you need to equip them and they have a limited number of charges. Combat wands can miscast occasionally, but you also can squeeze additional charge out of them. Utility wands spend all of their charges on use, and their effect depends on amount of charges used.",
        ...
        },
        {
            ...
            "Most equipment has condition level. It slowly decreases as the item is used, but can be restored with the corresponding repair tools. Every condition level affects item performance just as much as upgrade level does, but it doesn't affects the strength requirement of the weapon or the number of charges of the wand.",
            ...
            "Your most readily available source of healing is your waterskin. When used, it recovers part of your missing health, and can be refilled in occasional water fountains. There is always at least one fountain per chapter.",
            "As you descend deeper into the dungeon, ambient lighting becomes less and less noticeable, limiting your field of vision. To counter this, you can use torches scattered around the dungeon. They nullify your stealth though.",
            ...
            "On your quest, you can find randomly colored potions. Some of them are beneficial and some of them are harmful. Beneficial potions buff you when used, and harmful potions can be thrown into your enemies.",
            "Sometimes in the high grass you can find alchemical herbs. Throw three of them into an alchemy pot to brew a potion. Type of the potion will depend on the herbs you used. Using herbs of the same type will always produce corresponding potion.",
