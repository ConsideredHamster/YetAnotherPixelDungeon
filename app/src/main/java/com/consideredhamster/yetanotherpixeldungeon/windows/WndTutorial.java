    ...
    private static final String[][] TXT_POINTS = {
        {
            ...
            "Tap this button to make your character search nearby tiles, revealing traps and secret doors. Press and hold this button to examine anything you meet in the dungeon - tiles, items, enemies.",
